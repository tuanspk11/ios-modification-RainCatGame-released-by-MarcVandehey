...
class MenuSceneNode : SceneNode, MenuNavigation, SKPhysicsContactDelegate, MenuNodeAnimation {
  ...
  @objc func setupSoundButton(maskNode : SKNode) {
  ...
  @objc func navigateToUrl(url: String) {
    if !isNavigating {
  ...
  @objc func navigateToMultiplerClassic() {
    if !isNavigating {
  ...
  @objc func navigateToMultiplayerCatPong() {
    if !isNavigating {
