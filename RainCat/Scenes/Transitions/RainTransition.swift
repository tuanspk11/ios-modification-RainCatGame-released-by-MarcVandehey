...
class RainTransition : SKNode {
  ...
  @objc var sprites = [[SKSpriteNode]]()
  @objc var spriteNameDict = [String : Int]()
  ...
  @objc func performScaleInUniform(fromColor : SKColor, toColor : SKColor) {
  ...
  @objc func performScaleInEvenOdd(fromColor : SKColor, toColor : SKColor)  {
    let scaleAnim = getScaleAnimation(fromColor: fromColor, toColor: toColor, toScale: 1)
  ...
  @objc func performScaleInChecker(fromColor : SKColor, toColor : SKColor) {
    let scaleAnim = getScaleAnimation(fromColor: fromColor, toColor: toColor, toScale: 1)
  ...
  @objc func performScaleInLinearTop(fromColor : SKColor, toColor : SKColor) {
    let scaleAnim = getScaleAnimation(fromColor: fromColor, toColor: toColor, toScale: 1)
  ...
  @objc func performScaleSpiral(toScale: CGFloat, atPoint: CGPoint, fromColor : SKColor, toColor : SKColor) {
  ...
  @objc func getScaleAnimation(fromColor : SKColor, toColor : SKColor, toScale: CGFloat) -> SKAction {
  ...
  @objc func getSpriteName(row: Int, col: Int) -> String {
    return "\(col).\(row)"
  }
}
