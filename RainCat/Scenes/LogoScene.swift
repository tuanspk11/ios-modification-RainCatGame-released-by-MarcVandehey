...
public class LogoScene : SceneNode {
  ...
  @objc let backgroundSprite = SKSpriteNode()
  @objc let maskNode = SKCropNode()
  @objc let circleNode = SKShapeNode(circleOfRadius: 20)

  @objc let t23Logo = SKSpriteNode()

  @objc var logoFrames = [SKTexture]()
