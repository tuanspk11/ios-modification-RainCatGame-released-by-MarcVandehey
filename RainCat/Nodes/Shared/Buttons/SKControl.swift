...
class SKAControlSprite : SKSpriteNode {
  ...
  @objc private(set) var currentTouch : UITouch?
  ...
  @objc func beginTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
    if currentTouch == nil {
      currentTouch = touch
      return true
    }
  ...
  @objc func continueTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
    return currentTouch == touch
  }

  @objc func endTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
  ...
  @objc func cancelTracking(_ touch: UITouch, with event: UIEvent?) -> Bool {
    if currentTouch == touch {
      currentTouch = nil
      return true
    }
