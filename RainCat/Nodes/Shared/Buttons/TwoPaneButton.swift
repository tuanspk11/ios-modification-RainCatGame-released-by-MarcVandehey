...
class TwoPaneButton : SKAControlSprite {
  ...
  @objc convenience init(text: String, textSize: CGFloat, size : CGSize) {
  ...
  @objc func updateElevation(newElevation : CGFloat) {
  ...
  @objc func setup(text: String, fontSize: CGFloat) {
  ...
  @objc let moveKey = "moving_the_button_yay!"

  @objc func moveTo(y: CGFloat, duration: TimeInterval = 0.5, delay: TimeInterval = 0.0) {
  ...
  @objc func moveTo(x: CGFloat, duration : TimeInterval = 0.5, delay: TimeInterval = 0.0) {
