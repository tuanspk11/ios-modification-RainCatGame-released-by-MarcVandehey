...
public class ShadowLabelNode : SKNode {
  ...
  @objc init(fontNamed: String) {
    super.init()

    setup(fontNamed: fontNamed)
  }

  @objc func setup(fontNamed: String) {
  ...
  @objc public var fontSize : CGFloat = 32 {
    didSet {
  ...
  @objc public var horizontalAlignmentMode = SKLabelHorizontalAlignmentMode.center {
    didSet {
  ...
  @objc public func getLCDVersion() -> SKLabelNode {
