...
class LCDScreenNode : SKSpriteNode, Resetable {
  ...
  @objc let startSpeed = 190.0
  @objc let endSpeed = 40.0

  @objc let endLinear = 20.0
  @objc let startScore = 1.0
  @objc let endScore = 200.0
  ...
  @objc func update(deltaTime : TimeInterval) {
    hudNode.update()
  ...
  @objc func addRaindrop(atIndex index : Int) {
  ...
  @objc func checkUmbrellaLevelRaindrop(atIndex index : Int) -> Bool {
    if indexInBounds(index: index) {
