...
public class PingPongHud : SKNode {
  ...
  @objc private(set) var playerOneScore = 0
  @objc private(set) var playerTwoScore = 0

  private let highScoreColor = SKColor(red:1.00, green:1.00, blue:0.69, alpha:1.0)

  @objc public func setup(size: CGSize) {
  ...
  @objc public func incrementPlayerOne() {
    showQuitButton()
  ...
  @objc public func incrementPlayerTwo() {
    showQuitButton()
  ...
  @objc func showMessageIndefinitely(message : String) {
  ...
  @objc func showRematchButton() {
    showingRematchButton = true

    rematchButton.alpha = 1
  }

  @objc func hideRematchButton() {
