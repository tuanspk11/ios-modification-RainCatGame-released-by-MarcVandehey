...
class TitleMenuNode : SKNode, MenuNodeAnimation {
  ...
  @objc var singlePlayerButton : TwoPaneButton!
  @objc var multiPlayerButton : TwoPaneButton!
  @objc var titleText : ShadowLabelNode!
  @objc var tutorialButton : TwoPaneButton!

  @objc var selectedButton : TwoPaneButton?
