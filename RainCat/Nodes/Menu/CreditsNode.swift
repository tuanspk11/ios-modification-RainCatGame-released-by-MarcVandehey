...
public class CreditsNode : SKNode, MenuNodeAnimation {
  ...
  @objc var marcButton : CreditLabelButtonSprite!
  @objc var jeffButton : CreditLabelButtonSprite!
  @objc var bensoundButton : CreditLabelButtonSprite!
  @objc var cathrynButton : CreditLabelButtonSprite!
  @objc var morganButton : CreditLabelButtonSprite!
  @objc var lauraButton : CreditLabelButtonSprite!
  @objc var logoButton : LogoButtonSprite!

  @objc var developmentLabel : SKLabelNode!
  @objc var designLabel : SKLabelNode!
  @objc var musicLabel : SKLabelNode!
  ...
  @objc func setup(sceneSize: CGSize) {
  ...
  @objc func navigateOutToLeft(duration: TimeInterval) {

  }

  @objc func navigateInFromLeft(duration: TimeInterval) {

  }

  @objc func navigateOutToRight(duration: TimeInterval) {
  ...
  @objc func navigateInFromRight(duration: TimeInterval) {
  ...
  @objc func tempDisableButton(duration : TimeInterval) {
