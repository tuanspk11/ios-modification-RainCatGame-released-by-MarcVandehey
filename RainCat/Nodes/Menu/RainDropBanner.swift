...
public class RainDropBanner : SKNode, Touchable {
  ...
  @objc public func setup(maskNode : SKNode) {
    for i in 0...23 {
  ...
  @objc public func touchBegan(touch: UITouch) {
  ...
  @objc func enlargeRaindrop(_ raindrop : SKSpriteNode) {
  ...
  @objc public func touchMoved(touch: UITouch) {
    //Not implemented
  }

  @objc public func touchEnded(touch: UITouch) {
    //Not implemented
  }

  @objc public func touchCancelled(touch: UITouch) {
    //Not implemented
  }

  @objc public func update(size: CGSize) {
    for node : RainDrops in rainDrops {
