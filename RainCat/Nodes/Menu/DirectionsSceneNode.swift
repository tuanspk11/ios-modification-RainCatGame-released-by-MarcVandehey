...
class DirectionsSceneNode : SceneNode, SKPhysicsContactDelegate {
  ...
  @objc let spawnRate : TimeInterval = 0.25
  @objc var currentSpawnTime : TimeInterval = 0
  ...
  @objc func getSpawnLocation() -> CGPoint {
